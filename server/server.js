...
app.get('/*', function (req, res) {
  res.sendFile(path.join(__dirname, '/build/index.html'), function (err) {
    if (err) {
      res.status(500).sendFile(__dirname, '/views/index.html')
    }
  });
})
...
// mongodb+srv://lai:<password>@stockcheckgcp.5tgxa5t.mongodb.net/?retryWrites=true&w=majority
// username: lai
// password: StockCheck2022@